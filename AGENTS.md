...
3. Skill [`.cursor/skills/reagent-rc-oneshot/SKILL.md`](.cursor/skills/reagent-rc-oneshot/SKILL.md) — **one** Cursor tool call over Unreal RC when MCP discovery fails
